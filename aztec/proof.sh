#!/usr/bin/env bash
# bash <(curl -s https://raw.githubusercontent.com/RomanTsibii/nodes/main/aztec/proof.sh) PORT
set -euo pipefail
...
# Встановлення порту: якщо передано аргумент, використовуємо його; інакше — 8080
PORT="${1:-8080}"
